...
public class QomExe {
    ...
    public static String[] selectedOF_;
    // amount evaluations
    public static int numberOfEval_;
    // maximum evaluations
    public static int test_;
    public static String textOF_;

    // Basin file
    public static String description_;
    public static String shapeName_; // Fast, Triangle, Trapeze, Rectangle, Oval, Slow
    public static double shape_; // coefficient of bsin shape, 0.5 to 2.5
    public static double area_; // km2
    public static double pervious_; // 0.0 to 1.0
    public static double CT_; // concentration time
    public static String dateIni_; // "yyyy/MM/dd hh:mm:00 tt"
    public static String dateFin_; // "yyyy/MM/dd hh:mm:00 tt"
    public static String dateIniPartial_; // "yyyy/MM/dd hh:mm:00 tt"
    public static String dateFinPartial_; // "yyyy/MM/dd hh:mm:00 tt"
    public static double Δt_; // hours decimal
    public static int regIni_;
    public static int regFin_;
    public static Boolean Percolation_is_base_flow_; // True or False
    public static double Added_direct_infiltration_; // True or False
    public static double Qoi_; // initial flow in impervious area (m3/s)
    public static double Qop_; // initial flow in pervious area (m3/s)
    public static double Qog_; // initial flow in ground water (m3/s)
    public static double Ro_; // humedad antecedente volume (mm)
    public static double So_; // humedad antecedente volume (mm)
    public static double Rmax_; // mm
    public static double Smax_; // mm
    public static double VC_; // mm/h
    public static double Ki_; // 1/s
    public static double Kp_; // 1/s
    public static double Kg_; // 1/s
    public static double Eq_;
    public static double Coefficient_to_increase_the_peaks_flow_ = 0.0;
    public static double Limits_to_increase_the_peaks_flow_ = 0.0;
    ...
    public static double EVTi_1_;
    // potential volumes
    public static double Dp_;
    // total volumes
    public static double sumVi_;
    public static double sumVp_;
    public static double sumVg_;
    public static double sumRunoffR_;
    public static double sumVixArea_;
    public static double sumVpxArea_;
    public static double sumVgxArea_;
    // moisture balance
    public static double Input_;
    public static double Evapotraspiration_;
    public static double SuperficialStore_;
    public static double SoilStore_;
    public static double StoreOrOutput_Deep_;
    ...
    public static int maxLine_, line_;
    // read variables in VAR jMetal file
    public static double[][] var_;
    // objetive function derivaded for validation test
    public static double[][] fd_;

    //  rainfall (constant)
    public static double[] Pconst_;
    ...
    public static double[] PEVTconst_;
    ...
    //  observed flow
    public static java.lang.Double[] Qo_;
    ...
    //  calculated flow
    public static java.lang.Double[] Qc_;
    ...
    public static double[] Vg_;

    public double getVg_(int reg) {
        return Vg_[reg];
    } // get Vg

    public static double[] RunoffR_;
    ...
    public static double peakQP_[] = new double[2];
    public static double peakQ_;
    public static double peakP_;
    public static int peakPindx_ = 0;
    public static int peakPindxQ_ = 0;
    public static double peakPQ_ = 0;
    public static double peakPV_ = 0;
    public static double peakPT_ = 0;

    public static int peakQindxP_ = 0;
    public static double peakQV_ = 0;
...
// colores
    ...
    public static void main(String[] args) throws IOException {       // name of class and problem
        ...
        System.out.println(purple_ + "Pass 2. Computing .." + reset_);
        Qom_Calculus();
        Function_Duration_Curve(Qc_);

        System.out.println(purple_ + "Pass 3. Evaluating .." + reset_);
        evaluate();

        System.out.println(purple_ + "Pass 4. Recording solutions .." + reset_);
